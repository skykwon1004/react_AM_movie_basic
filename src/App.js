    ...
    return (
        <Wapper>
            ...
            <Routes>
                ...
                <Route path="/detail/:id" element={<DetailMovie movie={movie} on={on} setOn={setOn} genreList={genreList} />} />
                <Route path="/genre/:id" element={<GenreDetail genreList={genreList} on={on} setOn={setOn} />} />
            ...
            {
                GL.map((it, idx) => <GenreMovie genre={it} key={idx} />)
            }
            <Footer>
                &copy; 2023 AM movie
            </Footer>
